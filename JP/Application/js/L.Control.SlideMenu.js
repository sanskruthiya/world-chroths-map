L.Control.SlideMenu = L.Control.extend({
    ...
    onAdd: function (map) {
        ...
        link.title = 'Open Information Window';
        L.DomUtil.create('span', 'fa fa-info fa-lg', link);
        ...
        if (this._isHorizontal){
            if (this._isLeftPosition) {
                ...
                L.DomUtil.addClass(closeButton, 'fa-backward');
            }
            else {
        ...
        //comment out if you want NOT to show the slide at the initial time
